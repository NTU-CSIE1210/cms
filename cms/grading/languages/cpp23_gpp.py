...
"""C++23 programming language definition."""
...
class Cpp23Gpp(CompiledLanguage):
    """This defines the C++ programming language, compiled with g++ (the
    version available on the system) using the C++23 standard.
    ...
    def get_compilation_commands(self,
        ...
        if for_evaluation:
            command += ["-DEVAL"]
        command += ["-std=gnu++23", "-O2", "-pipe", "-static",
